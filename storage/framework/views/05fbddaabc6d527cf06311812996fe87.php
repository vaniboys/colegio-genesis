...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <a href="<?php echo e(route('aluno.dashboard')); ?>" class="<?php echo e(request()->routeIs('aluno.dashboard') ? 'active' : ''); ?>">
            <i class="fas fa-home"></i> Dashboard
        </a>
        
        <a href="<?php echo e(route('aluno.boletim')); ?>" class="<?php echo e(request()->routeIs('aluno.boletim') ? 'active' : ''); ?>">
            <i class="fas fa-chart-line"></i> Boletim
        </a>
        
        <a href="<?php echo e(route('aluno.notas')); ?>" class="<?php echo e(request()->routeIs('aluno.notas') ? 'active' : ''); ?>">
            <i class="fas fa-edit"></i> Notas
        </a>
        
        <!-- ✅ MINHAS DISCIPLINAS - NOVO -->
        <a href="<?php echo e(route('aluno.minhas-disciplinas')); ?>" class="<?php echo e(request()->routeIs('aluno.minhas-disciplinas') ? 'active' : ''); ?>">
            <i class="fas fa-book-open"></i> Minhas Disciplinas
        </a>
        
        <a href="<?php echo e(route('aluno.materiais')); ?>" class="<?php echo e(request()->routeIs('aluno.materiais') ? 'active' : ''); ?>">
            <i class="fas fa-folder-open"></i> Materiais
        </a>
        
        <a href="<?php echo e(route('aluno.livros')); ?>" class="<?php echo e(request()->routeIs('aluno.livros') ? 'active' : ''); ?>">
            <i class="fas fa-book"></i> Livros de Apoio
        </a>
        
        <a href="<?php echo e(route('aluno.tarefas')); ?>" class="<?php echo e(request()->routeIs('aluno.tarefas') ? 'active' : ''); ?>">
            <i class="fas fa-tasks"></i> Tarefas
        </a>

        <a href="<?php echo e(route('aluno.historico')); ?>" class="<?php echo e(request()->routeIs('aluno.historico') ? 'active' : ''); ?>">
            <i class="fas fa-history"></i> Histórico Escolar
        </a>
        
        <a href="<?php echo e(route('aluno.comunicados')); ?>" class="<?php echo e(request()->routeIs('aluno.comunicados') ? 'active' : ''); ?>">
            <i class="fas fa-bullhorn"></i> Comunicados
        </a>
        
        <hr>
        
        <a href="<?php echo e(route('aluno.mensagens')); ?>" class="<?php echo e(request()->routeIs('aluno.mensagens*') ? 'active' : ''); ?>">
            <i class="fas fa-envelope"></i> Mensagens
            <span class="menu-badge" id="menuMensagensBadge" style="display: none;">0</span>
        </a>
        
        <a href="<?php echo e(route('aluno.notificacoes')); ?>" class="<?php echo e(request()->routeIs('aluno.notificacoes*') ? 'active' : ''); ?>">
    ...
    <div class="container-fluid p-3">
        ...
        <div class="topbar">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0">Olá, <?php echo e(auth()->user()->name); ?></h5>
            ...
            <div class="d-flex align-items-center gap-3">
                <!-- Ícone de Mensagens -->
                <div class="notification-icon" onclick="window.location.href='<?php echo e(route('aluno.mensagens')); ?>'">
                ...
                <div class="notification-icon" onclick="window.location.href='<?php echo e(route('aluno.notificacoes')); ?>'">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text"><strong><?php echo e(auth()->user()->name); ?></strong></span></li>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('aluno.boletim')): ?>
...
<script>
    ...
    function carregarMensagensCount() {
        fetch('<?php echo e(route("aluno.mensagens.count")); ?>')
    ...
    function carregarNotificacoesCount() {
        fetch('<?php echo e(route("aluno.notificacoes.count")); ?>')
            .then(response => response.json())
            .then(data => {
                const count = data.count || 0;
...
</html><?php /**PATH C:\xampp\htdocs\colegio-genesis-oficial\resources\views/layouts/aluno.blade.php ENDPATH**/ ?>