...
<div class="card">
    ...
    <div class="card-body p-0">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notificacoes->count() > 0): ?>
            ...
            <div class="p-3 border-bottom <?php echo e(!$notificacao->lida ? 'bg-light' : ''); ?>">
                ...
                <p class="mb-0 mt-1"><?php echo e($notificacao->mensagem); ?></p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notificacao->link): ?>
                    <a href="<?php echo e($notificacao->link); ?>" class="btn btn-sm btn-link mt-2">Ver detalhes</a>
...
<?php echo $__env->make('layouts.professor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\colegio-genesis-oficial\resources\views/professor/notificacoes.blade.php ENDPATH**/ ?>