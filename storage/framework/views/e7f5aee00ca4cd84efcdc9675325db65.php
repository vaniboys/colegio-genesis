...
<div class="table-card">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <div>
            <h5 class="mb-0" style="color: #1e3a8a;">
                <i class="fas fa-edit me-2"></i> Lançar Notas - <?php echo e($turma->nome); ?>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <div class="d-flex gap-3 flex-wrap">
            ...
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('professor.notas', ['turma' => $turma->id, 'trimestre' => 1, 'disciplina_id' => $disciplinaId ?? 1])); ?>" 
                   class="btn btn-sm <?php echo e($trimestre == 1 ? 'btn-primary' : 'btn-outline-primary'); ?>">
                    <i class="fas fa-calendar-week me-1"></i> 1º Trimestre
                </a>
                <a href="<?php echo e(route('professor.notas', ['turma' => $turma->id, 'trimestre' => 2, 'disciplina_id' => $disciplinaId ?? 1])); ?>" 
                   class="btn btn-sm <?php echo e($trimestre == 2 ? 'btn-primary' : 'btn-outline-primary'); ?>">
                    <i class="fas fa-calendar-week me-1"></i> 2º Trimestre
                </a>
                <a href="<?php echo e(route('professor.notas', ['turma' => $turma->id, 'trimestre' => 3, 'disciplina_id' => $disciplinaId ?? 1])); ?>" 
                   class="btn btn-sm <?php echo e($trimestre == 3 ? 'btn-primary' : 'btn-outline-primary'); ?>">
            ...
            <div class="dropdown">
                <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                    <i class="fas fa-book me-1"></i> <?php echo e($disciplinaSelecionada->nome ?? 'Selecionar Disciplina'); ?>
                ...
                <ul class="dropdown-menu">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $disciplinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disciplina): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <li>
                            <a class="dropdown-item <?php echo e(($disciplinaId ?? 1) == $disciplina->id ? 'active' : ''); ?>" 
                               href="<?php echo e(route('professor.notas', ['turma' => $turma->id, 'trimestre' => $trimestre, 'disciplina_id' => $disciplina->id])); ?>">
                                <i class="fas fa-book me-2"></i> <?php echo e($disciplina->nome); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($matriculas->count() > 0): ?>
        <form method="POST" action="<?php echo e(route('professor.notas.salvar')); ?>" id="formNotas">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="turma_id" value="<?php echo e($turma->id); ?>">
            <input type="hidden" name="trimestre" value="<?php echo e($trimestre); ?>">
            <input type="hidden" name="disciplina_id" value="<?php echo e($disciplinaId ?? 1); ?>">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $matriculas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matricula): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                        ...
                        ?>
                        <tr class="aluno-row" data-matricula-id="<?php echo e($matricula->id); ?>">
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-circle me-2">
                                        <span class="avatar-text"><?php echo e(substr($matricula->aluno->nome_completo, 0, 1)); ?></span>
                                    </div>
                                    <div>
                                        <strong><?php echo e($matricula->aluno->nome_completo); ?></strong><br>
                                        <small class="text-muted">
                                            <i class="fas fa-id-card me-1"></i> 
                                            Matrícula: <?php echo e($numeroMatricula); ?>
                            ...
                            <td class="text-center">
                                <input type="number" 
                                       name="notas[<?php echo e($matricula->id); ?>][avaliacao_continua]" 
                                       value="<?php echo e($mac); ?>"
                                       class="form-control form-control-sm text-center nota-input mac-input" 
                                       step="0.5" min="0" max="20"
                                       data-matricula="<?php echo e($matricula->id); ?>"
                                       placeholder="0-20">
                            </td>
                            <td class="text-center">
                                <input type="number" 
                                       name="notas[<?php echo e($matricula->id); ?>][prova_trimestral]" 
                                       value="<?php echo e($prova); ?>"
                                       class="form-control form-control-sm text-center nota-input prova-input" 
                                       step="0.5" min="0" max="20"
                                       data-matricula="<?php echo e($matricula->id); ?>"
                                       placeholder="0-20">
                            </td>
                            <td class="text-center align-middle media-trimestral-cell" data-matricula="<?php echo e($matricula->id); ?>">
                                <strong class="media-trimestral-valor" style="font-size: 1.1rem">
                                    <?php echo e($mediaTrimestral ? number_format($mediaTrimestral, 1) : '—'); ?>

                                </strong>
                            </td>
                            <td class="text-center">
                                <input type="number" 
                                       name="notas[<?php echo e($matricula->id); ?>][exame_final]" 
                                       value="<?php echo e($exame); ?>"
                                       class="form-control form-control-sm text-center exame-input" 
                                       step="0.5" min="0" max="20"
                                       data-matricula="<?php echo e($matricula->id); ?>"
                                       placeholder="Opcional">
                            </td>
                            <td class="text-center align-middle media-final-cell" data-matricula="<?php echo e($matricula->id); ?>">
                                <strong class="media-final-valor" style="font-size: 1.1rem">
                                    <?php echo e($mediaFinal ? number_format($mediaFinal, 1) : '—'); ?>
                            ...
                            <td class="text-center">
                                <div class="d-flex flex-column align-items-center">
                                    <input type="number" 
                                           name="notas[<?php echo e($matricula->id); ?>][faltas]" 
                                           value="<?php echo e($faltas); ?>"
                                    ...
                                    <div class="progress w-100" style="height: 6px;">
                                        <div class="progress-bar faltas-progress" 
                                             style="width: <?php echo e($percentagemFaltas); ?>%; <?php echo e($percentagemFaltas > 50 ? 'background-color: #dc2626' : ($percentagemFaltas > 25 ? 'background-color: #eab308' : 'background-color: #22c55e')); ?>">
                                        </div>
                                    </div>
                                    <small class="text-muted faltas-percent">
                                        <?php echo e($percentagemFaltas); ?>% 
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($percentagemFaltas >= 50): ?> 
                                            <i class="fas fa-exclamation-triangle text-danger"></i>
                                        <?php elseif($percentagemFaltas >= 25): ?>
                                            <i class="fas fa-clock text-warning"></i>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </small>
                                </div>
                            </td>
                            <td class="text-center align-middle situacao-cell" data-matricula="<?php echo e($matricula->id); ?>">
                                <?php echo $__env->make('components.situacao-badge', ['situacao' => $situacao], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </td>
                        </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </tbody>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function salvarAutomaticamente() {
        ...
        fetch('<?php echo e(route("professor.notas.salvar.ajax")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.professor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\colegio-genesis-oficial\resources\views/professor/notas.blade.php ENDPATH**/ ?>