...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <a class="nav-link <?php echo e(request()->routeIs('professor.dashboard') ? 'active' : ''); ?>" 
           href="<?php echo e(route('professor.dashboard')); ?>">
            <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>
        
        <a class="nav-link <?php echo e(request()->routeIs('professor.turmas*') ? 'active' : ''); ?>" 
           href="<?php echo e(route('professor.turmas')); ?>">
            <i class="fas fa-chalkboard-user"></i> Minhas Turmas
        </a>
        
        <a class="nav-link <?php echo e(request()->routeIs('professor.avaliacoes*') ? 'active' : ''); ?>" 
           href="#" onclick="return false;">
            <i class="fas fa-tasks"></i> Avaliações
        </a>
        
        <a class="nav-link <?php echo e(request()->routeIs('professor.tarefas*') ? 'active' : ''); ?>" 
           href="#" onclick="return false;">
        ...
        <a class="nav-link <?php echo e(request()->routeIs('professor.mensagens*') ? 'active' : ''); ?>" 
           href="<?php echo e(route('professor.mensagens')); ?>">
            <i class="fas fa-envelope"></i> Mensagens
            <span class="badge bg-danger rounded-pill" id="menuMensagensBadge" style="display: none; float: right;">0</span>
        </a>
       
        <a class="nav-link <?php echo e(request()->routeIs('professor.notificacoes*') ? 'active' : ''); ?>" 
           href="<?php echo e(route('professor.notificacoes')); ?>">
...
<div class="main-content">
    <div class="container-fluid p-3">
        ...
        <div class="topbar d-flex justify-content-between align-items-center flex-wrap">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">Bem-vindo, <?php echo e(auth()->user()->name); ?></small>
                </div>
            </div>
            
            <div class="d-flex align-items-center gap-3 mt-2 mt-sm-0">
                <!-- Ícone Mensagens -->
                <a href="<?php echo e(route('professor.mensagens')); ?>" class="text-decoration-none position-relative">
                ...
                <!-- Ícone Notificações -->
                <a href="<?php echo e(route('professor.notificacoes')); ?>" class="text-decoration-none position-relative">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!request()->routeIs('professor.dashboard') && !request()->routeIs('professor.turmas')): ?>
        <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\colegio-genesis-oficial\resources\views/layouts/professor.blade.php ENDPATH**/ ?>